...
- GIVEN Pi negotiates against the pinned v3.6.1 provider
...
- GIVEN `.gentle-ai/` holds only pre-v3.6.1 runtimes
- WHEN Pi resolves the pinned executable
- THEN negotiation fails hard, naming the expected v3.6.1 version, rather than degrading to an older runtime
